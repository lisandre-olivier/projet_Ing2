...
<body>
 ...
 <c:choose>  <%-- Debut c:choose  --%>
		<c:when test="${empty pompiers}">
			<div class="alert alert-warning alert-dismissible" role="alert">
				<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
				<strong>Aucun pompier trouvé ! La liste des pompiers est vide !</strong>
			</div>
		</c:when>
...
<!-- 		<table  id="prodtable" class="table table-striped"> -->
		<table id="prodtable" class="table table-striped table-bordered">
			...
			<tfoot>
       	   ...
       	   <tbody>
			<c:forEach var="pomp" items="${pompiers}">
			
				<spring:url value="/pompier/get/${pomp.idPompier}"	var="pompUrl" /> 
				<spring:url value="/pompier/delete/${pomp.idPompier}" var="deleteUrl" />
				<spring:url value="/pompier/update/${pomp.idPompier}" var="updateUrl" />
				<spring:url value="/pompier/clear" var="clearUrl" />
				
				<tr>
					<td width="5%">${pomp.idPompier}</td>
					<td width="30%">${pomp.nomPompier}</td>
					<td width="30%">${pomp.prenomPompier}</td>
					<td width="10%">${pomp.agePompier}</td>
	
					<td>
					
						<button class="btn btn-success"	onclick="location.href='${pompUrl}'">
						show
						</button>
		    ...
		    <div class="modal-dialog">
		      ...
		      <div class="modal-content">
		        ...
		        <div class="modal-body">
			       <h3>Êtes-vous sûr de vouloir supprimer définitivement ce pompier ?
		...
		<div class="modal fade" id="clearModal" role="dialog">
		    <div class="modal-dialog">
		      ...
		      <div class="modal-content">
		        ...
		        <div class="modal-body">
			       <h3>Êtes-vous sûr de vouloir vider la liste de toutes les pompiers ? 
			      	 <br><br><small>NB: Cette opération est irréversible !</small>
