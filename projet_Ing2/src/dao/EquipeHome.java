...
public class EquipeHome {
	...
	public Equipe merge(Equipe detachedInstance) {
		...
		try {
			Equipe result = (Equipe) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Equipe findById(java.math.BigDecimal id) {
		log.debug("getting Equipe instance with id: " + id);
		try {
			Equipe instance = (Equipe) sessionFactory.getCurrentSession().get("dao.Equipe", id);
			if (instance == null) {
	...
	public List findByExample(Equipe instance) {
		log.debug("finding Equipe instance by example");
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("dao.Equipe").add(Example.create(instance))
					.list();
