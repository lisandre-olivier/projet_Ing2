...
public class ManagementHome {
	...
	public Management merge(Management detachedInstance) {
		...
		try {
			Management result = (Management) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Management findById(java.math.BigDecimal id) {
		log.debug("getting Management instance with id: " + id);
		try {
			Management instance = (Management) sessionFactory.getCurrentSession().get("dao.Management", id);
			if (instance == null) {
	...
	public List findByExample(Management instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("dao.Management")
