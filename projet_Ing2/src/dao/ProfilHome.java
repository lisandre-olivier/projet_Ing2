...
public class ProfilHome {
	...
	public Profil merge(Profil detachedInstance) {
		...
		try {
			Profil result = (Profil) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Profil findById(java.math.BigDecimal id) {
		log.debug("getting Profil instance with id: " + id);
		try {
			Profil instance = (Profil) sessionFactory.getCurrentSession().get("dao.Profil", id);
			if (instance == null) {
	...
	public List findByExample(Profil instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("dao.Profil").add(Example.create(instance))
					.list();
